        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-8 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    ...
                    <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted in more than 100 countries & 5 million customers. Have any query ? Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laudantium eaque quibusdam voluptatum eos, numquam a ipsum quia id ea quaerat!</p>
                </div>
                <!--End Col-->
